...
class ScopusImporter
{
    ...
    public function importScopus(): bool
    {
        ...
        foreach ($years as $year) {
            ...
            $this->processScopus($filename, $year);
        }

        return true;
    }

    private function processScopus(string $file_path, int $anno): void
    {
        ...
        $journalRepository = new JournalRepository($this->mysqli);
